...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean showDel = getIntent().getBooleanExtra(EXTRA_SHOW_DEL, true);
    ...
    private void showDeleteDialog() {
        ...
        if (mMediaItems.get(mCurrentPosition).mimeType.startsWith("image")) {
            sweetDialog.setTitle("要删除这张照片吗？");
        } else {
            sweetDialog.setTitle("要删除这个视频吗？");
        }
