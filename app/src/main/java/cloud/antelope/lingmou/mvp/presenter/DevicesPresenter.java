...
@FragmentScope
public class DevicesPresenter extends BasePresenter<DevicesContract.Model, DevicesContract.View> {
    @Inject
    ...
    @Inject
    public DevicesPresenter(DevicesContract.Model model, DevicesContract.View rootView) {
