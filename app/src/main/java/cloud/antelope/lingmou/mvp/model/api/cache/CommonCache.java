/**
  ...
  */
package cloud.antelope.lingmou.mvp.model.api.cache;
...
public interface CommonCache {
    ...
    // @LifeCache(duration = 2, timeUnit = TimeUnit.MINUTES)
    // Observable<Reply<LoginEntity>> login(Observable<LoginEntity> users, DynamicKey username, EvictProvider evictProvider);
