...
public class SelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    private void initViews() {
        mAdapter = new DialogAdapter(mName);
    ...
    public class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.default_text_color);
                mOtherItemColor = mActivity.getResources().getColor(R.color.default_text_color);
            }
            if (1 == mStrings.size()) {
