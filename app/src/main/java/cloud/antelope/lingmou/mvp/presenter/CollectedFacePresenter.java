...
@ActivityScope
public class CollectedFacePresenter extends BasePresenter<CollectedFaceContract.Model, CollectedFaceContract.View> {
    @Inject
    ...
    @Inject
    public CollectedFacePresenter(CollectedFaceContract.Model model, CollectedFaceContract.View rootView) {
