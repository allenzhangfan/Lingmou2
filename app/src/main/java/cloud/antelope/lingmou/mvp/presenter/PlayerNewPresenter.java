...
@ActivityScope
public class PlayerNewPresenter extends BasePresenter<PlayerNewContract.Model, PlayerNewContract.View> {
    @Inject
    ...
    @Inject
    public PlayerNewPresenter(PlayerNewContract.Model model, PlayerNewContract.View rootView) {
