...
@ActivityScope
public class SearchCameraPresenter extends BasePresenter<SearchCameraContract.Model, SearchCameraContract.View> {
    ...
    @Inject
    public SearchCameraPresenter(SearchCameraContract.Model model, SearchCameraContract.View rootView
    ...
    public void searchCamera(String key, String type, String count, String offset, String isOnline) {
        if (!NetworkUtils.isConnected()) {
            mRootView.showMessage(Utils.getContext().getResources().getString(R.string.network_disconnect));
            return;
        }

        mModel.searchCamera(key, type, count, offset, isOnline)
                ...
                .subscribe(new ErrorHandleSubscriber<OrganizationEntity>(mErrorHandler) {
                    ...
                    public void onNext(OrganizationEntity entity) {
                        mRootView.onSearchCameraSuccess(entity);
                    }
                    ...
                    public void onError(Throwable t) {
                        ...
                        if (t instanceof SuccessNullException) {
                            mRootView.onSearchCameraSuccess(new OrganizationEntity());
                        } else {
                            mRootView.onSearchCameraError();
                        }
                    }
                });
    }
