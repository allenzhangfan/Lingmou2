...
@ActivityScope
public class AccountHeadPresenter extends BasePresenter<AccountHeadContract.Model, AccountHeadContract.View> {
    @Inject
    ...
    @Inject
    public AccountHeadPresenter(AccountHeadContract.Model model, AccountHeadContract.View rootView) {
