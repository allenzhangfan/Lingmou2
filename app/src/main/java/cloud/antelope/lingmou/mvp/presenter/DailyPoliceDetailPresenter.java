...
@ActivityScope
public class DailyPoliceDetailPresenter extends BasePresenter<DailyPoliceDetailContract.Model, DailyPoliceDetailContract.View> {
    @Inject
    ...
    @Inject
    public DailyPoliceDetailPresenter(DailyPoliceDetailContract.Model model, DailyPoliceDetailContract.View rootView) {
    ...
    public void collectAlarmInfo(String alarmId) {
        if (!NetworkUtils.isConnected()) {
            mRootView.showMessage(Utils.getContext().getResources().getString(R.string.network_disconnect));
            return;
        }
        mModel.collectAlarmInfo(alarmId)
                .doOnSubscribe(disposable -> {
                    mRootView.showLoading("");//显示下拉刷新的进度条
                }).subscribeOn(AndroidSchedulers.mainThread())
                .observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new ErrorHandleSubscriber<Object>(mErrorHandler) {
                    @Override
                    public void onNext(Object faceDepotEntity) {
