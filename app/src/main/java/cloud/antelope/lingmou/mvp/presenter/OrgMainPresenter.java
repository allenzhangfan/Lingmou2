...
@ActivityScope
public class OrgMainPresenter extends BasePresenter<OrgMainContract.Model, OrgMainContract.View> {
    @Inject
    ...
    @Inject
    public OrgMainPresenter(OrgMainContract.Model model, OrgMainContract.View rootView) {
