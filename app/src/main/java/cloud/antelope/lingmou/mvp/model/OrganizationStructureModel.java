...
@ActivityScope
public class OrganizationStructureModel extends BaseModel implements OrganizationStructureContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public OrganizationStructureModel(IRepositoryManager repositoryManager) {
