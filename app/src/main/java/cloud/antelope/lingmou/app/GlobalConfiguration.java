...
import cloud.antelope.lingmou.mvp.model.api.LmHeaderInterceptor;
...
public final class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        if (BuildConfig.LOG_DEBUG) { //Debug 时,让框架打印 Http 请求和响应的信息
        ...
        builder.baseurl(Api.APP_DOMAIN)
                ...
                .addInterceptor(new LmHeaderInterceptor(new HashMap<>()))  // 添加拦截器
