package cloud.antelope.lingmou.app.utils.transition;
...
public class CommentEnterTransition extends Visibility {
    ...
    public CommentEnterTransition(Context context, View topBarView) {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        topBarHeight = mTopBarView.getMeasuredHeight();

        // 保存 计算初始值
        transitionValues.values.put(PROPNAME_TOP_BAR_TRANSITION_Y, topBarHeight);
    }
