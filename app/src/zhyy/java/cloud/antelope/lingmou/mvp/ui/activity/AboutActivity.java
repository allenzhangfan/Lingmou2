...
public class AboutActivity extends BaseActivity<AppUpdatePresenter> implements AppUpdateContract.View {
    ...
    @OnClick({R.id.about_img, R.id.call_service_btn, R.id.law_btn, R.id.version_update_btn, R.id.head_left_iv,R.id.btn_update_info})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_update_info:
                startActivity(new Intent(AboutActivity.this,UpdateInfoActivity.class));
                break;
    ...
    public void showUpdateDialog(boolean isForce, String versionDescription, String downloadUrl) {
        mUpdateDialog = ViewUtils.showUpgradeDialog(isForce, versionDescription, AboutActivity.this,
                v -> {
